    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
		            ...
		            <span class="input-group-addon" style="border-radius: 0;">学　　号<span style="color:red;margin-top:13px;">*</span></span>
		            <input type="text" name="no" id="no" class="form-control" placeholder="学号" required>
		        </div>
		        <br>
		        <div class="input-group" style="margin-left:20%;margin-right:20%">
		            <span class="input-group-addon" style="border-radius: 0;">学生名字<span style="color:red;margin-top:13px;">*</span></span>
		            <input type="text" name="name" id="name" class="form-control" placeholder="学生名字" required>
		        </div>
		        <br>
            	<div class="input-group" style="margin-left:20%;margin-right:20%">
            	...
            	<br>
            	<div class="input-group" style="margin-left:20%;margin-right:20%">
		            <span class="input-group-addon" style="border-radius: 0;">课程性质 </span>
		            <input type="text" name="courseNature" id="courseNature" class="form-control" placeholder="课程性质" required>
		        </div>
		        <br>
		        <div class="input-group" style="margin-left:20%;margin-right:20%">
		            <span class="input-group-addon" style="border-radius: 0;">课程学分</span>
		            <input type="number" name="credit" id="credit" class="form-control" placeholder="课程学分" required>
		        </div>
		        <br>
		         <div class="input-group" style="margin-left:20%;margin-right:20%">
		            <span class="input-group-addon" style="border-radius: 0;">成　　绩<span style="color:red;margin-top:13px;">*</span></span>
		            <input type="number" name="score" id="score" class="form-control" placeholder="成绩" required>
		        </div>
...
<script>
	...
	$("#addConfirm").click(function(){
		...
		var courseNature = $("#courseNature").val();
		var credit = $("#credit").val();
		var score = $("#score").val();
		
		if( no != "" && name != "" && courseName != "" &&  score != "" ){
			$.ajax({
				type:"post",
