...
public class StudentController_guo {
	...
	public String inspection(String studentno,HttpServletRequest request,HttpServletResponse response){		
		try {
			response.getWriter().println(studentService.inspection(studentno));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}finally {
