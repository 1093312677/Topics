...
//		String hql = "SELECT new Topics( id,  topicsName,  introduce,  time, directions, "
//				+ "selectedStudent,  enableSelect,  state,  taskBookName,  intentionNumber)"
//				+ "FROM Topics t LEFT JOIN Teacher te WHERE te.id ="+teacherId;
