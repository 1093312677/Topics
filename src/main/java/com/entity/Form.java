...
//	和学生表实现一对一
	...
	public Form(long id, String openingReport, String interimReport, String interimEvalForm,
			String reviewEvalForm, String reviewTable, String replyRecord, String fileName) {
		super();
		this.id = id;
