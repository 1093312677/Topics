    		...
    		<div class="panel panel-default" style="margin-top:25px;">
			   ...
			   <!-- 判断是否提交文档 -->
			    	<c:if test="${fileName != null }">
		    		 	<tr>
		    		 		<td><a href="<%=request.getContextPath() %>/document/download.do?randName=${fileName }&documentName=${name }_中期报告_${fileName }">下载</a></td>
		    		 	</tr>
		    		 </c:if>
		    		 <c:if test="${fileName == null }">
		    		 	<tr>
			    		 	...
			    		 	<td>
			    		 		<form id="form" action="" method="post" enctype="multipart/form-data">
									 <div class="input-group">
							            <span class="input-group-addon" style="border-radius: 0;">中期报告</span>
...
<script>
	...
	$("#save").click(function(){
		...
		function(){
			...
			$.ajax({
				type:"post",
				url:"<%=request.getContextPath() %>/attach/addMidReport.do",
				data:form,
				dataType:"json",
				processData:false,
	            contentType:false,
