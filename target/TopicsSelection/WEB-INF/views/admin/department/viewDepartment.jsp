    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	...
            	<div class="panel panel-danger" style="margin-top:30px;width:50%;margin-left:25%" id="message3">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
            	...
            	<br>
				<label>系：</label><input type="text" name="departmentname1" placeholder="系名称（*必填）" id="departmentname1" class="form-control" onchange="inspection1()"/>
            	<br>
...
<script>
	...
	function inspection1(){
		...
		$.ajax({
			type:"post",
			url:"<%=request.getContextPath()%>/department/inspection.do",
			data:{"departmentName":departmentName},
			dataType:"text",
			success:function(data){
				if(data==1){
					$("#updateInfo").attr("disabled", true);
					$("#departmentname1").focus().select();
					$("#message03").fadeIn();
				}
				else{
					$("#message03").hide();
	...
	function showInput(){
		//选取学院后，错误消息隐藏
		$("#message2").hide();
		$(".department-content").html("<input type='text' class='form-control' id='department' onchange='inspection()' hidden='hidden' placeholder='系' required/>");
